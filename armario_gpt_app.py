...
# Datos con imágenes de Google Drive
data = [
...
st.markdown("### ¿Qué tipo de día tienes hoy?")
st.markdown("Selecciona el tipo de clima y ocasión, y te recomendamos un outfit.")
...
if st.button("Sugerir outfit"):
    ...
    sugerencias = data[:3]  # Mostrar los primeros 3 por simplicidad
